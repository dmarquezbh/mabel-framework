...
public class XcodeNativeDeployTests
{
    ...
    {
        var plist = XcodeNativeDeploy.BuildInfoPlist("ios_app", "com.example.mabeltest");
        ...
        Assert.Contains("<string>com.example.mabeltest</string>", plist);
    ...
    {
        var output = "  1) AB12CD34EF \"Apple Development: Seu Nome (TEAMID1234)\"\n     1 valid identities found";
        Assert.Equal("Apple Development: Seu Nome (TEAMID1234)", XcodeNativeDeploy.ParseFirstCodesigningIdentity(output));
    }
    ...
    public void Execute_MontaAssinaEInstalaAppBundle_QuandoXcodebuildSoProduzExecutavelNu()
    {
        ...
        var shell = new FakeShellExecutor()
            ...
            .WithResult("security find-identity -v -p codesigning", 0,
                "  1) AB12CD34EF \"Apple Development: Seu Nome (TEAMID1234)\"\n     1 valid identities found")
