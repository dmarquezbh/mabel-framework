...
Core Graphics / SkiaSharp. O spike do Board iOS provou o render — mas o app abria
...
Tipos de nó v1 (suficientes pro Board Kanban):
...
existem — reaproveitados. Emite `board-sdui.json`.

## Prova end-to-end mínima

Board Kanban em **controles nativos de verdade**:
