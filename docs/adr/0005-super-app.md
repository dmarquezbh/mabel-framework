...
+ SDUI → controles nativos). O Daniel enquadrou o alvo real: o app **Org** é um
**super-app** que incorpora funcionalidades de vários times (Kanban, Chat, …). A
arquitetura já suporta isso naturalmente — falta nomear e documentar como pilar.

Necessidade organizacional: **cada time da Org entrega o seu mini-app; o super-app Org
...
5. **Chat entra como mini-app webview** (reuso imediato da web existente) ao lado dos
...
6. **Isolamento é garantia-por-design:** publicar/atualizar um mini-app (ex.: Ledger) **não
...
- (+) Alinha a arquitetura à estratégia Org: um app, features por time, sem reinstalar.
...
3. Chat: webview-mini-app já (recomendado) vs. esperar SDUI.
