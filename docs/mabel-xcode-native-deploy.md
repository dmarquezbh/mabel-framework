...
o iPhone fisico **crow5** (UDID `00008020-000119A42682002E`, iOS 18.7.9,
...
de `mabel deploy . --build-tool xcode --device 00008020-000119A42682002E`:

- ✅ **O bloqueio original esta 100% resolvido**: `xcodebuild build -destination
  "id=00008020-000119A42682002E"` roda ate o fim e imprime `** BUILD SUCCEEDED **`
