...
¹ descritor → UIKit com scroll + tap nativos validado no device (a prova do Board); o
...
- **Descritor SDUI → UIKit nativo** (ADR 0001): schema commitado; view-builder iOS rascunhado
  em `feat/sdui-descriptor`; o tap-through no device é a prova do Board, sign-off final
  pendente.
