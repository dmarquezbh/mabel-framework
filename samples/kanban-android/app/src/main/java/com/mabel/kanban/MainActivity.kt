...
// =============================================================================
// Mabel Kanban (Android) — app de prova do spike SDUI (schema v2).
// Carrega o MESMO kanban-sdui.json (Onda 2) usado pelo host iOS (assets/),
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val json = assets.open("kanban-sdui.json").bufferedReader().use { it.readText() }
