...
header = node("hdr", TEXT,
    props={"text": "Operações", "fontSize": 22, "weight": 3, "color": TEXTC,
           "padding": {"top": 8, "right": 16, "bottom": 8, "left": 16}},
    a11y={"role": 2, "label": "Lista de operações do board"},   # header
    responsive=[
...
home = node("screen:home", SCREEN,
    ...
    nav={"route": "home", "title": "PJUS — Onda 2"},
...
out = "/home/dmarques/apps/rui-native/ios_app/Sources/ios_app/Resources/board-sdui.json"
