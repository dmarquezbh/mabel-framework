...
public static class SduiSchema
{
    ...
    /// navegação e degradação graciosa (Onda 1). v3 = theming/dark-mode, i18n,
    /// forms+validação, catálogo ampliado, media, animações e lifecycle (Onda 🟡).
...
public static class SduiCompatibility
{
    ...
    public static bool IsKnown(this SduiNodeType type) =>
        type is >= SduiNodeType.Screen and <= SduiNodeType.Audio;
